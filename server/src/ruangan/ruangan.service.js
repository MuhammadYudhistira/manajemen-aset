const { findRuangan, findRuanganById, insertRuangan, editRuanganById, deleteRuanganById } = require("./ruangan.repository")
...
const createRuangan = async (newRuanganData) =>{
    const ruangan = await insertRuangan(newRuanganData)
    return ruangan
}
...
module.exports = {getAllRuangan, getRuanganById, createRuangan, editRuangan, deleteRuangan }
