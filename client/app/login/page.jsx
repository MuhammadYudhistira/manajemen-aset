...
const page = () => {
  return (
    <section className="max-h-[100vh] bg-white">
      <div className="w-full lg:flex lg:min-h-screen">
        <div className="flex h-screen w-full flex-col px-16 py-32 md:px-28 md:py-52 lg:w-[50%]">
          <a
          ...
          <h1 className="mt-6 text-xl font-bold text-gray-900 md:text-2xl">
            Login
          </h1>
          <p className="mt-4 leading-relaxed text-gray-500">
            Masukkan informasi detail untuk masuk ke dalam sistem
          </p>
          <form action="#" className="mt-8 flex w-full flex-col gap-6">
        ...
        <div className="hidden bg-gray-100 p-5 lg:flex lg:w-[50%]">
          <img
            alt=""
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Coat_of_arms_of_West_Sumatra.svg/800px-Coat_of_arms_of_West_Sumatra.svg.png"
