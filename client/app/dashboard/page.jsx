...
const page = () => {
    return (
        <>
            <section className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 w-full">
            ...
            <section className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                <div className="flex flex-col lg:col-span-2 bg-white p-5 rounded-xl border w-full">
            ...
            <section className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                ...
                <div className="bg-white p-5 rounded-xl border w-full lg:col-span-2">
                    <h3 className="font-bold mb-0 p-0">Jumlah Aset</h3>
                    <BarCharts />
                </div>
            </section>
        </>
