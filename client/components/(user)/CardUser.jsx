...
const CardUser = ({ profile, nama, role, nip, alamat, jenis_kelamin, no_hp, id }) => {
    return (
        <div className="group bg-white rounded-lg border">
            <ActionUser id={id} />
            <Image src={`${process.env.NEXT_PUBLIC_IMAGE_URL}/${profile}`} width={500} height={500} alt={nama} className='size-[100px] xl:size-[150px] rounded-full mx-auto object-cover object-center' />
