...
const EditAsetForm = ({ id }) => {
    ...
    const { mutate: editAset, isPending, isSuccess } = useEditAset({
        onSuccess: () => {
    ...
    return (
        <form className='w-full space-y-2' onSubmit={formik.handleSubmit}>
            <label className="form-control w-full">
                ...
                <input type="text" placeholder="Nama Barang" name='nama_barang' value={formik.values.nama_barang} onChange={handleFormInput} className="input bg-blue-50 text-black text-sm" required />
            </label>
            <label className="form-control w-full">
                <div className="label">
                    <span className="label-text">Merk</span>
                </div>
                <input type="text" placeholder="Merk" name='merk' value={formik.values.merk} onChange={handleFormInput} className="input bg-blue-50 text-black text-sm" required />
            </label>
            <label className="form-control w-full">
                <div className="label">
                    <span className="label-text">Deskripsi</span>
                </div>
                <textarea type="text" placeholder="Deskripsi" name='deskripsi' value={formik.values.deskripsi} onChange={handleFormInput} className="input textarea bg-blue-50 text-black text-sm" required />
            </label>
            <DatePicker
                maxValue={today}
                ...
                showMonthAndYearPickers label={`Tahun perolehan : ${dateObject}`}
                color='primary'
            />
            <label className="form-control w-full">
                <div className="label">
                ...
                <input type="text" placeholder="Ukuran" name='ukuran' value={formik.values.ukuran} onChange={handleFormInput} className="input bg-blue-50 text-black text-sm" required />
            </label>
            <label className="form-control w-full">
                <div className="label">
                    <span className="label-text">Harga Satuan</span>
                </div>
                <input type="number" placeholder="harga_satuan" name='harga_satuan' value={formik.values.harga_satuan} onChange={handleFormInput} className="input bg-blue-50 text-black text-sm" required />
            </label>
            <label className="form-control w-full">
                <div className="label">
                    <span className="label-text">Jumlah Barang</span>
                </div>
                <input type="number" placeholder="Jumlah Barang" name='jumlah_barang' value={formik.values.jumlah_barang} onChange={handleFormInput} className="input bg-blue-50 text-black text-sm" required />
            </label>
